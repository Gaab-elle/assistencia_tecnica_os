...
import ClienteLista from '../components/ClienteLista.vue' // <--- ADICIONE ESTA LINHA: IMPORTAÇÃO DO COMPONENTE
...
{ // <--- NOVA ROTA PARA ClienteLista
path: '/clientes/lista', // Defina um caminho URL para o ClienteLista
name: 'clientes-lista', // Defina um nome único para esta rota
component: ClienteLista // Associe o componente ClienteLista a esta rota
}
